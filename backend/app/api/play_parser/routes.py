...
def play_parser_meta():
    ...
    """
    return {"service": "play-parser", "endpoints": ["/evaluate", "/evaluate-compare", "/detect"]}
...
async def evaluate_compare(
    ...
    """
    Run selected parsers plus optional decoder path; return comparison metrics when both produce events.
    """
    keys = _parse_parser_keys(parser_keys)
    ...
    try:
        ...
        want_dec = _truthy_form(include_decoders)
